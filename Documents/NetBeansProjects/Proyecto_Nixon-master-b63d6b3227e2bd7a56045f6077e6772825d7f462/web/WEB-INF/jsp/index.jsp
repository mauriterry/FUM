                ...
                <div id="immersive_slider">
                    <div class="slide" data-blurred="">
                        <div class="col-md-6 image">
                            <img src="images/b2.jpg" alt="Slider 1" />
                        </div>
                        <div class="col-md-6 content">
                            <h3>Centauros <span>Bank</span></h3>
                            <p>Contamos con una amplia red de atención y un portafolio completo de productos con los que tendrás beneficios, alianzas y promociones.</p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="slide" data-blurred="">
                        <div class="col-md-6 image">
                            <img src="images/b3.jpg" alt="Slider 1" />
                        </div>
                        <div class="col-md-6 content">
                            <h3>Centauros <span>Bank</span></h3>
                            <p>Pensamos en tu experiencia y en la tranquilidad de cuidar tus recursos, tus ahorros y la mesada pensional. </p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="slide" data-blurred="">
                        <div class="col-md-6 image">
                            <img src="images/B1.jpg" alt="Slider 1" />
                        </div>
                        <div class="col-md-6 content">
                            <h3>Centauros <span>Bank</span></h3>
                            <p>El estilo de vida de Centauros bank, se traduce en ser 
                                atendido siempre con prioridad, tener a su disposición espacios 
                                exclusivos, estar asegurado a donde vaya, tener privilegios en los 
                                lugares que visita y contar permanentemente con un equipo 
                                especializado. </p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
