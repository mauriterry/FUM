...
<html lang="en">
   ...
   <div class="about-heading">
                        <h2>Solicitudes <span>Rechazadas</span></h2>
                    </div>
                    <!-- //about-heading -->
                            ...
                            <table id="tablaResultado" class="table table-striped table-hover table-bordered" >
                                ...
                                <c:forEach var="p" items="${listaSolicitud}">                                           
                                    <tr>
                                        ...
                                        <td>${p.getNombre1()} ${p.getNombre2()} ${p.getApellido1()} ${p.getApellido2()}</td>
                                        <td><a href="SolicitudCrear/${p.identificacion}">Crear</a></td>                             
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
