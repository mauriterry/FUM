                        ...
                        <div class="container">
                            <div class="signin-form profile">
                                ...
                                <div class="login-form">
                                    <form action="SolicitudRegistrar.htm" method="post">
                                         <BR>
                                        AUTORIZACIÓN TRATAMIENTO DATOS PERSONALES:
                                        <BR> Si
                                        <INPUT TYPE="radio" NAME="ADP" VALUE="SI" required="">
                                        <input type="text" value="<%=request.getParameter("pal") %>" name="identificacion" readonly="readonly" >
                                         <table align="center">
                                             <tr>
                                                    <td >
                                                        <br>Ciudad de Ubicación:<br>
                                                        <select name="ciudad" required="" placeholder="Ciudad de Ubicación">
                                                            <option selected >-Ciudad de Ubicación-</option>
                                                ...
                                                <option value="Medellin">Medellín</option>
                                                    ...
                                                    <td  >
                                                        <br>
                                                        Tipo de tarjeta:<br>
                                                     <select name="tipoT" required="" placeholder="Seleccione el tipo de tarjeta">
                                                <option selected>-Tipo de tarjeta-</option>
                                                <option value="Tarjeta Clasica visa">Tarjeta Clasica visa</option>
                                                <option value="Tarjeta Clasica MasterCard">Tarjeta Clasica MasterCard</option>
                                                <option value="Tarjeta Oro visa">Tarjeta Oro visa</option>
                                                <option value="Tarjeta Oro MasterCard">Tarjeta Oro MasterCard</option>
                                                <option value="Tarjeta Platinum visa">Tarjeta Platinum visa</option>
                                                <option value="Tarjeta Platinum MasterCard">Tarjeta Platinum MasterCard</option>
